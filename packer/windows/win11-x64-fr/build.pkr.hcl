...
variable "tpm_storage_pool" {
  description = "The storage pool to use for the TPM state file."
  type        = string
  default     = "local"
}

variable "tpm_version" {
  description = "The version of the TPM to emulate."
  type        = string
  default     = "v2.0"
}
...
build {
  ...
  provisioner "powershell" {
    script = "windows/win11-x64-fr/provision/scripts/Setup.ps1"
  }
}
